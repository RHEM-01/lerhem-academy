    ...
    async function signInWithGithub() {
        startGitHubTransition(async () => {
            await authClient.signIn.social({
                ...
                fetchOptions: {
                    onSuccess: () => {
                        toast.success("Signed in with Github, and you are being redirected...");
                    },
                    onError: (error) => {
            ...
            <CardContent className="flex flex-col gap-4">
                ...
                <div className="grid gap-3">
                    <div className="grid gap-2">
                        ...
                        <Input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="rhemajoseph@gmail.com" required />
                    </div>
